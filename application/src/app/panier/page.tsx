...
export default function PanierPage() {
    ...
    const handleValidCart = async () => {
        try {
            ...
            switch (reponse.gateway_response.status) {
                case "succeeded":
                    console.log("Paiement OK ✅", reponse.gateway_response.charges);
                    break;

                case "failed":
                    console.error("Paiement échoué ❌", reponse.gateway_response.error.message);
                    // exemple : afficher une notif / toaster
                    break;
            }
        } catch (err) {
